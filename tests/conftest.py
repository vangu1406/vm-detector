...
class _TestDetector(VMDetector):
    def check_cpu_info(self): pass
    def check_system_model(self): pass
    def check_mac_address(self): pass
    def check_processes(self): pass
    def check_specific_files(self): pass
    def additional_os_specific_checks(self): pass
