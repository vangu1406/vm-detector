...
def test_windows_check_system_model(windows_detector):
    with patch.object(windows_detector, 'run_command', return_value='manufacturer: vmware'):
...
def test_windows_check_mac_address(windows_detector):
    with patch.object(windows_detector, 'run_command', return_value='00:0c:29:12:34:56'):
